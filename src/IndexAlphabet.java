public class IndexAlphabet {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Follwing alphabets are:  a  b  c  d  e  f  g  h  i  j  k  l  m  n  o");
		System.out.println("Index of following are: " + a + " " + b + " " + c
				+ " " + d + " " + e + " " + f + " " + g + " " + h + " " + i
				+ " " + j + " " + k + " " + l + " " + m + " " + n + " " + o
				+ " ");

		System.out
				.println("Follwing alphabets are: p q  r  s  t u  v  w  x  y  z");
		System.out.println("Index of following are: " + p + " " + q + " " + r
				+ " " + s + " " + t + " " + u + " " + v + " " + w + " " + x
				+ " " + y + " " + z + " ");
	}
